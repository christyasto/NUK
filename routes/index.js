...
router.post("/login", passport.authenticate("local",
    {
        ...
        failureFlash: true,
        successFlash: 'Welcome to SUTD Events!'
    }), function(req, res){
});
...
router.get("/users/:id", function(req, res){
  User.findById(req.params.id).exec(function(err, foundUser){
    ...
    Event.find().where('author.id').equals(foundUser._id).exec(function(err, events){
      if(err){
        req.flash("error", "Problem fetching events posted!");
        req.redirect("/");
      }
...
router.post('/forgot', function(req, res, next) {
  async.waterfall([
    ...
    function(token, user, done) {
      ...
      var mailOptions = {
        to: user.email,
        from: 'nuk.sutd.app@gmail.com',
        subject: 'Nuk Sutd Events Password Reset',
...
router.post('/reset/:token', function(req, res) {
  async.waterfall([
    ...
    function(user, done) {
      ...
      var mailOptions = {
        to: user.email,
        from: 'nuk.sutd.app@mail.com',
        subject: 'Your password has been changed',
        text: 'Nuk Sutd Events,\n\n' +
